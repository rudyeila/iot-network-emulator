This network emulator was developed as part of my Bachelor's thesis at the Julius Maximilian University of Würzburg between April and September of 2019. A publication related to my Bachelor thesis, titled "An IoT Network Emulator for Analyzing the Influence of Varying Network Quality" can be found at [https://link.springer.com/chapter/10.1007/978-3-030-72795-6_47](springer). If this link doesn't work, look for the paper on [https://scholar.google.com/scholar?hl=de&as_sdt=0%2C5&q=An+IoT+Network+Emulator+for+Analyzing+the+Influence+of+Varying+Network+Quality&btnG=](google scholar).  
